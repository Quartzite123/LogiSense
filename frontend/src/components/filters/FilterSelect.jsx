    ...
    <div className="min-w-[180px]">
      <div className="mb-1 flex items-center justify-between gap-2">
        <span className="text-xs text-[#A1A1AA]">
          {label} <span className="text-[#71717A]">({hint})</span>
        </span>
        <span className="flex gap-2">
          <button onClick={() => onChange(options.slice())} className="text-[11px] text-[#71717A] hover:text-[#FFD60A]">
            All
          </button>
          <button onClick={() => onChange([])} className="text-[11px] text-[#71717A] hover:text-[#FFD60A]">
            Clear
          </button>
        </span>
      </div>
